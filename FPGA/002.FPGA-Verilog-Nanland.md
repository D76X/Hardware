...
# Clock Domains, FIFO and Block RAM (BRAM)

[Crossing Clock Domains in an FPGA nandland](https://www.youtube.com/watch?v=eyNU6mn_-7g&t=38s)  

[Crossing Clock Domains in an FPGA](https://nandland.com/lesson-14-crossing-clock-domains/)    

## FIFO

[What is a FIFO in an FPGA nandland](https://www.youtube.com/watch?v=Nr8q5VW-mXI)  

[How FIFO buffers are used to transfer data and cross clock domains](https://nandland.com/lesson-8-what-is-a-fifo/)   

## Block RAM (BRAM)

[What is a Block RAM in an FPGA? nandland](https://www.youtube.com/watch?v=fqUuvwl4QJA)  

[What is a Block RAM (BRAM) in an FPGA? Tutorial for beginners](https://nandland.com/lesson-15-what-is-a-block-ram-bram/)  

---

## Synthesizable vs. Non-Synthesizable code and Test Benches

[nandland: Lesson 6: Synthesizable vs. Non-Synthesizable code](https://nandland.com/lesson-6-synthesizable-vs-non-synthesizable-code/)   

[nandland: Tutorial – What is a Testbench](https://nandland.com/what-is-a-testbench/)

---

## FPGA Latch, D-Latch and its danger!

[Tutorial – What is an FPGA Latch?](https://nandland.com/lesson-9-what-is-a-latch/)  
[Tutorial – How to avoid creating Latches in your FPGA](https://nandland.com/how-to-avoid-creating-a-latch/)  
[Tutorial – How to avoid creating Latches in your FPGA](https://nandland.com/how-to-avoid-creating-a-latch/)  

Latches should never be used in a FPGA dsign for the following two reasons:
...
How are latches created by FPGA tools such as Verilog or VHDL? 

Latches are created when an there is an output that is not assigned 
under all possible input conditions in any of the following cases:

- you create a combinational process 
- conditional assignment (in VHDL)  
- a combinational always block (in Verilog) 
...
[Tutorial – Writing Combinational and Sequential Code Using VHDL Process or Verilog Always Blocks](https://nandland.com/tutorial-writing-combinational-and-sequential-code/)   
[Using Process (in VHDL) or Always Block (in Verilog) with Clocks - Sequential Code](https://nandland.com/tutorial-sequential-code-on-your-fpga/)  
...
In reality, a Process/Always Block used to define a block of combinational logic 
is seen far less often in “real-world” code than a Process/Always Block used to 
define sequential logic.

For sequential logic a Process/Always Block can

- have at most two signals in its sensitivity list 
- If the Process/Always Blocks uses an **asynchronous reset**, it will have **two signals in the sensitivity list**.
- If the FPGA designer uses a **synchronous reset or no reset**, it will only have **one signal in the sensitivity list**. 
